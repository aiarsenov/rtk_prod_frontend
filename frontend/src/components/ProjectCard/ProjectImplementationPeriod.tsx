                ...
                {projectData?.implementation_period !== null ? (
                    <>
                        <div>
                            ...
                            <Hint message="Срок реализации проекта в соответствии с последним завершённым отчётом проекта. Изменение отображается относительно срока реализации в отчёте проекта с наиболее ранней датой утверждения." />
                        </div>
