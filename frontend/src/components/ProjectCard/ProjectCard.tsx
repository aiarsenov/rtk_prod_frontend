                        ...
                        <section className="card__main-content project-card__main-content">
                            ...
                            <div className="project-card__services">
                                <div className="form-label">
                                    ...
                                    <Hint
                                        message={
                                            "Перечень уникальных услуг по типу (ФТА, ФТМ и т.д.) и регулярности  (единоразовый, ежеквартальный и т.д.) по проекту. Стоимость услуг отображается по данным последнего отчёта проекта соответствующего типа со статусом в порядке приоритета: «Запланирован», «В работе», «Завершён». "
                                        }
                                    />
                                </div>
                            ...
                            <section className="project-card__general-info">
                                ...
                                <div className="project-card__contragent">
                                    <div className="form-label">
                                        ...
                                        <Hint
                                            message={
                                                "Выбор заказчика из справочника покупателей в 1С:Бухгалтерия."
                                            }
                                        />
                                    </div>
                                ...
                                <div className="project-card__industries">
                                    <div className="form-label">
                                        ...
                                        <Hint
                                            message={
                                                "Выбор одной основной отрасли проекта из справочника «Отрасли». Набор отраслей задаётся в данном справочнике."
                                            }
                                        />
                                    </div>
                                ...
                                <div className="project-card__industries">
                                    <div className="form-label">
                                        ...
                                        <Hint
                                            message={
                                                "Выбор дополнительных отраслей проекта из справочника «Отрасли» (доступен множественный выбор). Набор отраслей задаётся в данном справочнике."
                                            }
                                        />
                                    </div>
                                ...
                                <div className="project-card__tep">
                                    <div className="form-label">ТЭП</div>
                            ...
                            <section className="project-card__project-team">
                                <h2 className="card__subtitle">
                                    Команда проекта
                                    <Hint
                                        message="Отображается на основании сотрудников и подрядчиков, добавленных в команды отчётов проекта.

                                            Приоритет 1: отчёты со статусом «В работе».
                                            Если есть отчёты со статусом «В работе», команда берётся из них.

                                            Приоритет 2: отчёты со статусом «Запланирован».
                                            Если нет отчётов со статусом «В работе», но есть «Запланирован», команда берётся из них.

                                            Приоритет 3: завершённые отчёты.
                                            - Если все отчёты завершены: находится отчёт с крайней датой утверждения;
                                            - Если в том же месяце есть другие завершённые отчёты, команда берётся из всех отчётов этого месяца."
                                    />
                                </h2>
                            ...
                            <section className="project-card__project-executors">
                                <h2 className="card__subtitle">
                                    ...
                                    <Hint message="Добавить значок подсказки: Можно создать или выбрать ранее созданных ключевых лиц заказчика (справочник «Контакты заказчиков»). После создания ключевого лица внесение изменений в ФИО, должность и т.д. доступно только через справочник «Контакты заказчиков»." />
                                </h2>
